...
<head>
  ...
  <title>Distilasi Shop Admin - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Distilasi Shop Admin</div>
      </a>
      ...
      <li class="nav-item" >
        <a class="nav-link collapsed" href="index.php?halaman=produk"  >
      ...
      <li class="nav-item" >
        <a class="nav-link collapsed" href="index.php?halaman=tambah_admin"  >
          <i class="fas fa-fw fa-cog"></i>
            ...
            <div id="page-inner">
                ...
                if (isset($_GET['halaman'])) 
                {
                    ...
                    if ($_GET['halaman']=="detail")
                    {
                     ...
                     if ($_GET['halaman']=="tambah_produk")
                    {
                       include 'tambah_produk.php'; 
                    }
                    if ($_GET['halaman']=="hapus_produk")
                    {
                       include 'hapus_produk.php'; 
                    }
                    if ($_GET['halaman']=="ubah_produk")
                    {
                       include 'ubah_produk.php'; 
                    }
                    if ($_GET['halaman']=="tambah_admin")
                    {
